...
from submodules.absapp.utils import _read_generic_lex_for_similarity
from submodules.absapp import TRAIN_OUT, TRAIN_LEXICONS, GENERIC_OP_LEX
...
from utils.embedding import load_word_embeddings
