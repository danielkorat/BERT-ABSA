...
from submodules.absapp import TRAIN_LEXICONS
from submodules.absapp import TRAIN_OUT, GENERIC_OP_LEX
from submodules.absapp.inference.data_types import Polarity
from submodules.absapp.train.data_types import AspectTerm, \
    DepRelation, DepRelationTerm, LoadOpinionStopLists, LoadAspectStopLists, OpinionTerm, \
    QualifiedTerm
from submodules.absapp.train.rules import rule_1, rule_2, rule_3, rule_4, rule_5, rule_6
from submodules.absapp.utils import _load_parsed_docs_from_dir, _write_final_opinion_lex, \
...
class AcquireTerms(object):
    ...
    def __init__(self, asp_thresh=3):
        self.opinion_candidate_list_prev_iter = read_generic_lex_from_file(AcquireTerms.generic_opinion_lex_path)
