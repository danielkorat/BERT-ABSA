...
from submodules import TrainableModel
...
class TransformerBase(TrainableModel):
    ...
    def __init__(self, model_type, model_name_or_path, labels: List[str] = None, config_name=None,
    ...
    def _train(self,
        ...
        for _ in train_iterator:
            ...
            if 0 < max_steps < global_step:
                ...
                break
            epochs_eval.append(self._evaluate_during_train(dev_data_set, test_data_set))
    ...
    def _evaluate_during_train(self, dev_data_set, test_data_set) -> dict:
        ...
        for ds_name, ds in zip(['dev', 'test'], [dev_data_set, test_data_set]):
            ...
            for d in ds:
                ...
                ds_evals[ds_name] = self.evaluate_predictions(logits, label_ids)
        return ds_evals
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_mask, segment_ids, label_id=None, valid_ids=None, core_feats=None):
        self.input_ids = input_ids
        self.input_mask = input_mask
        self.segment_ids = segment_ids
        self.label_id = label_id
        self.valid_ids = valid_ids
        self.core_feats = [feats[:-1] for feats in core_feats]
        self.gov = [feats[-1] for feats in core_feats]
